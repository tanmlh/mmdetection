_base_ = [
    '../_base_/datasets/planet_basemap_single_ann_2023q2_global_8x_test-6k.py',
...
save_cfg=dict(
    save_results=True,
    out_dir = '/home/fahong/Datasets/ai4eo3/planet_data_download/basemap/dataset_2023q2_v3/test_6k/gcp',
    out_poly_scale=1/8.,
)
